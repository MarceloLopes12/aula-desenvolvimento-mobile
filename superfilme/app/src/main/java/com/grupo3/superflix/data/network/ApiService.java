package com.grupo3.superflix.data.network;

import com.grupo3.superflix.data.network.response.categoria.CategoriasService;
import com.grupo3.superflix.data.network.response.filme.FilmesService;
