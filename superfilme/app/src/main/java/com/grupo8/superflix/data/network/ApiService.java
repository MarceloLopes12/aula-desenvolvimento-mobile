package com.grupo8.superflix.data.network;

import com.grupo8.superflix.data.network.response.categoria.CategoriasService;
import com.grupo8.superflix.data.network.response.filme.FilmesService;
